					...
					<div class="col">
						<div class="row custom-border">
							...
							<form action="./feedRegisterComplete" method="post" enctype="multipart/form-data">
								...
								<div class="row mt-1">
									<div class="col">
										<label class="custom-file-label" for="fileUpload" id="fileLabel">이미지 등록</label>
										<input name="feedImageFiles" type="file" class="form-control" id="fileUpload" multiple accept="image/*">
									</div>
								</div>
								<div class="row my-3">
