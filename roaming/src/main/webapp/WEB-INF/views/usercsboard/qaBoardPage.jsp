	...
	<div class="container">
		<div class="row mt-5">
			...
			<div class="col-8">
				...
				<div class="row h5 pb-2 mt-5 border-bottom border-success">
				  문의 Best5
				</div>
				...
				<div class="row">
					<div class="col">
						<table class="table table-striped ">
							...
							<tbody>
								<c:forEach items="${bestFive}" var="bestFive">
								<tr>
									<th scope="row">${bestFive.best.id }</th>
									<td>${bestFive.category.qa_category_name}</td>
									<td>
									...
									<td>${bestFive.user.user_name}</td>
									<td><fmt:formatDate value="${bestFive.best.qa_reg_date}" pattern="yyyy-MM-dd"/></td>
									<td>${bestFive.best.qa_read_count}</td>
									<td>${bestFive.best.qa_recommend_count}</td>
								</tr>
								</c:forEach>
							</tbody>
						</table>
