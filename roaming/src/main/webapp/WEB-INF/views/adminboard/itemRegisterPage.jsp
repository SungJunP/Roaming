            ...
            <div class="col-8">
                ...
                <div class="form-floating mb-3"> 
                    <div class="row mb-3">
                        ...
                        <div class="col">
                            <input type="text" name="item_name" class="form-control form-control-lg" id="floatingInput" maxlength="100" style="width: 300px;">
                        </div>
                        <div class="col-auto d-flex align-items-center">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col">
                            <input type="text" name="item_context" class="form-control form-control-lg" id="floatingInput" maxlength="100" style="width: 300px;">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-auto d-flex align-items-center">
